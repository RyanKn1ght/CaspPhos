...
(ref:generic-cons-fig) Visualisation of inflammatory Caspase cleavage sites consensus categorised by chemistry. A: all Caspases (`r casp_num` sites), B: Caspase-4 (`r casp4_num`), C: human Caspase-1 (`r casp1H_num`), D: murine Caspase-1 (`r casp1M_num`).
...
#Present consensus sequence plots in grid using patchwork.
...
Visualisations shown in Figure \@ref(fig:consensus-fig) demonstrate the lack of an observed consensus sequence 
