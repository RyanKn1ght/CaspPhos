...
(ref:species-figure) Representation of assessment of substrate P4-P1 conservation in model organsisms (Ape = *P. troglodytes*, Human =  *H. sapiens*, Mouse = *M. musculus*, Zebrafish = *D. rerio*. A) `r casp1H_num` sites cleaved by human Caspase-1. B) `r casp1M_num` sites cleaved by murine Caspase-1.
...
file <- "./data/processed/general_ST_prediction_phosphorylation.txt"
ST_sites <- read.table(file) %>% janitor::clean_names()
