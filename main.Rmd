...
#Reduce table to format accepted by DeepPhos, by isolating each residue that can be phosphorylated, the sequence it lies in, and its position in that sequence. 
